...
Name=$(curl -sS https://raw.githubusercontent.com/asri8021/permission/main/ipmini | grep $MYIP | awk '{print $2}')
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}              • PAKYAVPN X BACKDOOR •            $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo ""
...
vlesslink1="vless://${uuid}@${sts}${domain}:$tls?path=/vlessws&security=tls&encryption=none&type=ws&host=$sni&sni=$sni#${user}"
vlesslink2="vless://${uuid}@${sts}${domain}:$none?path=/vlessws&encryption=none&type=ws#${user}"
vlesslink3="vless://${uuid}@${sts}${domain}:$tls?mode=gun&security=tls&encryption=none&type=grpc&serviceName=vless-grpc&sni=$sni#${user}"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e " $COLOR1┌───────────────────────────────────────────────┐${NC}"
echo -e " $COLOR1│$NC   ${COLOR1}[01]${NC} • ADD VLESS      ${COLOR1}[04]${NC} • RENEW VLESS${NC}    $COLOR1│$NC"
echo -e " $COLOR1│$NC   ${COLOR1}[02]${NC} • TRIAL VLESS${NC}    ${COLOR1}[05]${NC} • USER ONLINE    $COLOR1│$NC"
echo -e " $COLOR1│$NC   ${COLOR1}[03]${NC} • DELETE VLESS                        ${NC} $COLOR1│$NC"
...
case $opt in
01 | 1) clear ; addvless ;;
01 | 2) clear ; trialvless ;;
03 | 3) clear ; delvless ;;
04 | 4) clear ; renewvless ;;
04 | 5) clear ; cekvless ;;
00 | 0) clear ; menu ;;
*) clear ; menu-vless ;;
esac
